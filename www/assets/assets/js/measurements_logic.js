// measurements_logic.js - Lógica da página de medidas
// Adaptado para eventos SPA

window.addEventListener('spa:enter-measurements_progress', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    // Recarregar dados via SPA
                    if (window.router) {
                        window.router.navigate(window.location.pathname + window.location.search);
                    } else {
