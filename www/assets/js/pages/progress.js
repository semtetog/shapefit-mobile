// Scripts inline extraídos de progress.html
...
let progressData = null;
                    ...
                    setTimeout(() => {
                        (async function() {
                            ...
                            try {
                                ...
                                console.error('Erro ao recarregar progresso via SPA:', error);
                            }
                        })();
                    }, 100);
                }
        ...
        function changePeriod(period) {
            ...
            if (!subtitleEl) {
                console.warn('[Progress] Elemento period-subtitle não encontrado');
                return;
            }
