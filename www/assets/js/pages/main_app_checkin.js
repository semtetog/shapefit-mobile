(function(){
    if (window.__MAIN_APP_CHECKIN_LOADED) return;
    window.__MAIN_APP_CHECKIN_LOADED = true;
...
// Expor funções utilizadas diretamente no HTML
                ...
                setTimeout(() => {
                    (async function() {
                        ...
                        try {
                            ...
                            // NÃO re-inicializar banners aqui - o banner-carousel.js já faz isso
                            // via evento spa-page-loaded, evitando duplicação
                        } catch (error) {
