// progress_page_logic.js - Lógica específica inline do progress.html
...
(function() {
    ...
    function changePeriod(period) {
        ...
        if (subtitleEl) {
            subtitleEl.textContent = subtitles[period];
        }
    ...
    // Evento quando a view Progress entra
    window.addEventListener('spa:enter-progress', function() {
        initProgressPage();
    });
    
    // Evento quando a view Progress sai (opcional, para cleanup)
    window.addEventListener('spa:leave-progress', function() {
