...
const bottomNavHTML = `
    <nav class="bottom-nav">
        <a href="${bottomNavBaseURL}/main_app.html" class="nav-item ${bottomNavActiveItem === 'home' ? 'active' : ''}">
            <i class="fas fa-home"></i>
        </a>
        <a href="${bottomNavBaseURL}/progress.html" class="nav-item ${bottomNavActiveItem === 'stats' ? 'active' : ''}">
            <i class="fas fa-chart-line"></i>
        </a>
        <a href="${bottomNavBaseURL}/diary.html" class="nav-item ${bottomNavActiveItem === 'diary' ? 'active' : ''}">
            <i class="fas fa-book"></i>
        </a>
        <a href="${bottomNavBaseURL}/explore_recipes.html" class="nav-item ${bottomNavActiveItem === 'explore' ? 'active' : ''}">
            <i class="fas fa-utensils"></i>
        </a>
        <a href="${bottomNavBaseURL}/more_options.html" class="nav-item ${bottomNavActiveItem === 'settings' ? 'active' : ''}">
